...
* **`make-scenarios/`**: JSON blueprints for the automation workflows (Webhooks, Data Processing, and Sheets Integration).
* **`knowledge-base-sanitized.md`**: The structured data used by the AI to learn about the menu and business rules.

---

## 🔧 Setup Instructions
1. Import the `.bpz` file into your **Botpress Cloud** Studio.
2. Import the JSON blueprints into your **Make.com** account.
3. Review the **Knowledge Base** file to customize your restaurant's menu and details.
4. Update the Webhook URLs in Botpress to match your new Make.com endpoints.
5. Connect a Google Spreadsheet to log incoming orders in real-time.
